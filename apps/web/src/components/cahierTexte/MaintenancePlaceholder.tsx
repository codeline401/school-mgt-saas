 ...
 * Partagé par tous les onglets du module "Cahier de texte & suivi pédagogique".
 *
 * @param titre       - Nom de la fonctionnalité à venir.
 * @param description - Description courte du module une fois terminé.
 */
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 gap-4 text-center">
      ...
      <p className="text-base-content/40 text-xs mt-2">
        Cette fonctionnalité sera disponible prochainement. Merci de votre
        patience.
      </p>
    </div>
  );
