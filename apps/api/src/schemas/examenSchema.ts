...
export const createExamenSessionSchema = ExamenSessionSchema.refine(
  (data) => data.heureDebut < data.heureFin,
  {
...
export const updateExamenSessionSchema = ExamenSessionSchema.partial();
